    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm15SubCommunity"], // Updated field name
                "filter": {
                    "%ufCrm15SubCommunity": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueSubCommunities.has(item.ufCrm15SubCommunity)) {
                                uniqueSubCommunities.add(item.ufCrm15SubCommunity);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm15SubCommunity;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm15SubCommunity;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
